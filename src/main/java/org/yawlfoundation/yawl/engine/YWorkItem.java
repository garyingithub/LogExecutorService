...
import static org.yawlfoundation.yawl.engine.YWorkItemStatus.statusDeadlocked;
import static org.yawlfoundation.yawl.engine.YWorkItemStatus.statusDeleted;
import static org.yawlfoundation.yawl.engine.YWorkItemStatus.statusDiscarded;
...
import static org.yawlfoundation.yawl.engine.YWorkItemStatus.statusFailed;
import static org.yawlfoundation.yawl.engine.YWorkItemStatus.statusFired;
...
import static org.yawlfoundation.yawl.engine.YWorkItemStatus.statusSuspended;
...
public class YWorkItem {
    ...
    private void deleteWorkItem(YPersistenceManager pmgr, YWorkItem item)
        ...
        _eventLog.logWorkItemEvent(item, statusDeleted,
                createLogDataList(statusDeleted.name()));
    ...
    public void set_prevStatus(String status) {
         _prevStatus = (status != null ) ? fromString(status) : null ;
    }
    ...
    private YLogDataItemList createLogDataList(String tag) {
        ...
        if (tag.equals(statusExecuting.name())) {
            YLogDataItem dataItem = getDecompLogPredicate(valueOf(tag));
    ...
    private YLogDataItemList getCompletionPredicates() {
        ...
        if (completionItem != null) {
            ...
            completionItem = getDecompLogPredicate(statusComplete);
    ...
    private YLogDataItem getDecompLogPredicate(YWorkItemStatus itemStatus) {
        ...
        if (logPredicate != null) {
           if (itemStatus.equals(statusExecuting)) {
               predicate = logPredicate.getParsedStartPredicate(this);
           }
           else if (itemStatus.equals(statusComplete)) {
